...
[`niro.index`][] for reusable lookup tables, [`niro.rewrite`][] for functional
edits, [`niro.passes`][] for the
pass interface, and [`niro.verify`][] for verification.
...
from niro import builder, index, ir, passes, rewrite, verify
